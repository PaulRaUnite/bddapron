...
(* aaffectation: ca commence � �tre bon
   substitution, par substitution des variables booleennes par leur expression (ce qui introduit des contraintes, puis parcours: � voir *)
